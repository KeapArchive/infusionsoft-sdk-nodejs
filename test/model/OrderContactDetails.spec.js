...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfusionsoftRestApi.OrderContactDetails();
  });
  ...
  describe('OrderContactDetails', function() {
    it('should create an instance of OrderContactDetails', function() {
      ...
      //var instane = new InfusionsoftRestApi.OrderContactDetails();
      //expect(instance).to.be.a(InfusionsoftRestApi.OrderContactDetails);
    });
