...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfusionsoftRestApi.ProductStatus();
  });
  ...
  describe('ProductStatus', function() {
    it('should create an instance of ProductStatus', function() {
      ...
      //var instane = new InfusionsoftRestApi.ProductStatus();
      //expect(instance).to.be.a(InfusionsoftRestApi.ProductStatus);
    });
