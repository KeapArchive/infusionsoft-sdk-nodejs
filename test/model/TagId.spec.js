...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InfusionsoftRestApi.TagId();
  });
  ...
  describe('TagId', function() {
    it('should create an instance of TagId', function() {
      // uncomment below and update the code to test TagId
      //var instane = new InfusionsoftRestApi.TagId();
      //expect(instance).to.be.a(InfusionsoftRestApi.TagId);
    });
